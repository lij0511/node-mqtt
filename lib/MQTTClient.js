...
function execCommand(client, message) {
  var commands = {
    ...
    'CONNECT' : function() {
      ...
      if(message.ack === 0) {
        if(message.willFlag) {
          /* will publish the will message */
          client.willFlag = true;
          client.willQos = message.willQos;
          client.willRetain = message.willRetain;
          client.willTopic = message.willTopic;
          client.willMessage = message.willMessage;
        }
