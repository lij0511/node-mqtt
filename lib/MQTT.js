...
for(var k in module.exports.MessageType) {
  var v = module.exports.MessageType[k];
  module.exports.MessageCode[v] = k;
}
  
module.exports.mqttCommand = function(client, message) {
  var commands = {
    /* CONNECT 0x01 */
    'CONNECT' : function() {
